...
export const mockContactPageData: ContactPageData = {
  ...
  methods: [
    ...
    },
    {
      ...
      value: "123 Grill Street, Food City",
      helper: "Find us in the heart of the food district.",
      href: "https://maps.google.com/?q=123+Grill+Street+Food+City",
    },
  ],
  openingHours: [
  ...
  map: {
    ...
    address: "123 Grill Street, Food City",
    mapsUrl: "https://maps.google.com/?q=123+Grill+Street+Food+City",
  },
  form: {
    heading: "Send us a",
    accent: "Message",
