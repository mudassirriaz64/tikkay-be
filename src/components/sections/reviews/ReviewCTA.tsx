        ...
        <Reveal className="mx-auto max-w-[760px] text-center">
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              ...
              className="group/rev inline-flex h-12 items-center justify-center rounded-xl bg-[var(--accent-orange)] px-7 text-sm font-bold uppercase tracking-[0.12em] text-[var(--text-on-orange)] transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_36px_rgba(255,86,42,0.45)] active:scale-[0.98]"
            >
              {data.primaryLabel}
            </Link>
            <Link
              href={data.secondaryHref}
              className="group/rev2 inline-flex h-12 items-center justify-center rounded-xl border border-[var(--accent-peach)]/40 bg-black/40 px-7 text-sm font-bold uppercase tracking-[0.12em] text-[var(--accent-peach)] backdrop-blur-sm transition-all duration-300 hover:scale-[1.04] hover:border-[var(--accent-peach)] hover:bg-[var(--accent-peach)] hover:text-[var(--text-on-peach)] active:scale-[0.98]"
            >
              {data.secondaryLabel}
            </Link>
          </div>
