...
import { getOpenJobs, getAllJobsAdmin, createJob, updateJob, deleteJob, applyForJob, getAllApplications, updateApplicationStatus, deleteApplication, } from './careers.controller';
const router = Router();
router.route('/jobs')
    .get(getOpenJobs)
