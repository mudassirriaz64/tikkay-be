...
import { getMenuPageData, getCategories, createCategory, updateCategory, deleteCategory, getMenuItems, getMenuItem, createMenuItem, updateMenuItem, deleteMenuItem, getPageConfig, updatePageConfig, } from './menu.controller';
const router = Router();
