...
import { CustomerReview, Statistic, VideoReview, ReviewsPageConfig, } from './reviews.model';
...
export const approveReview = asyncHandler(async (req, res) => {
    const { id } = req.params;
    const review = await CustomerReview.findByIdAndUpdate(id, { is_approved: true }, { new: true });
    if (!review) {
...
export const getVideoReviews = asyncHandler(async (_req, res) => {
...
export const updateVideoReview = asyncHandler(async (req, res) => {
    const { id } = req.params;
