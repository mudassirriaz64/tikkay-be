...
import { getContactPageData, submitContactForm, getSubmissions, markSubmissionRead, deleteSubmission, contactMethods, openingDays, getPageConfig, updatePageConfig, } from './contact.controller';
const router = Router();
