...
export declare const getFavorites: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getMyReviews: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getAccountsPageData: (req: Request, res: Response, next: import("express").NextFunction) => void;
